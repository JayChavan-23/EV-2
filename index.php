                ...
                <div class="about__container container grid">
                    ...
                    <div class="about__data">
                        <h2 class="section__title about__title">
                            EV-2 <br> <i class="ri-flashlight-fill"></i> The Electric Bike shop <i class="ri-flashlight-fill"></i>
                        </h2>
                    ...
                    <div class="swiper-wrapper">
                        <article class="popular__card swiper-slide">
                            <div class="shape shape__smaller"> </div>
                                ...
                                <h1 class="popular__title">Ather</h1>
                                <h3 class="popular__subtitle">450X</h3>

                                <img src="assets/img/popular1.png" alt="" class="popular__img">

                                <div class="popular__data">
                                    <div class="popular__data-group">
                                        <i class="ri-dashboard-2-line"></i> 80 km/hr
                                         
                                    </div>
                                    <div class="popular__data-group">
                                        <i class="ri-timer-line"></i> 5.45hr
                                    </div>
                                    <div class="popular__data-group">
                                        <i class="ri-charging-pile-line"></i>116km per charge
                                    </div>
                                </div>

                                <h3 class="popular__price">₹143,136*</h3>
                    ...
                    <div class="featured__content grid">
                        ...
                        <article class="featured__card mix pureev">
                            <div class="shape shape__smaller"></div>
                                ...
                                <img src="assets/img/pureev/Pure-EV-First-Electric-Bike-ETRYST-350.png" alt="" class="featured__img">
                ...
                <div class="appointment__bg">
                    <div class="appointment__container container grid">
                        <div class="appointment__data">
                            ...
                            <p class="appointment__description">Note:- Please follow Covid Guidelines and wear your mask while visiting</p>
...
<section class="testimonal section">
    ...
    <div class="testimonal__wrapper">
        <div class="testimonal__container">
            ...
            <p> <span> <i class="ri-double-quotes-l quote__left"></i></span> Lorem ipsum, dolor sit amet consectetur adipisicing elit. Unde, 
                ...
                odio minima commodi illo? asfcg asdbw shcdss <span><i class="ri-double-quotes-r quote__right"></i></span> </p>
        </div>
        <div class="testimonal__container">
            <div class="testimonal__profile">
                <div class="testimonal__imgBox">
        ...
        <section class="contact section" id="contact">
            ...
            <div class="row">
                <iframe class="map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3768.452271096561!2d72.95613891536772!3d19.175438653821196!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7b8e5321ecbfb%3A0xf7d295a999c47b89!2sMulund%20College%20of%20Commerce!5e0!3m2!1sen!2sin!4v1656475520062!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
                <form action="">
                    <h3>Fill The Form</h3>
